...
import { deleteEnderecoController } from "../../controllers/endereco/DeleteEnderecoByIdController";
...
enderecoRoutes.delete("/deletarendereco/:id", deleteEnderecoController.handle)
